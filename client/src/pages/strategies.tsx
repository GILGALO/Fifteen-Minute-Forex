                ...
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  <div className="bg-black rounded-xl border border-yellow-500/20 p-6 relative flex flex-col justify-end min-h-[300px]">
                    ...
                    <div className="relative h-40 flex items-end gap-1.5 pb-4">
                      ...
                      <div className="w-6 h-40 bg-green-500/80 border-2 border-yellow-500 shadow-[0_0_25px_rgba(234,179,8,0.4)] rounded-sm relative z-10" />
                      <div className="w-6 h-32 bg-red-600 border border-red-400 rounded-sm relative" />
                    </div>
                  </div>
                </div>
              </CardContent>
